        ...
        pythoneda-shared-pythonlang-artf-infrastructure-for = { python
          ...
          in python.pkgs.buildPythonPackage rec {
            ...
            postInstall = with python.pkgs; ''
              ...
              for dep in ${pythoneda-shared-artifact-artifact-events-infrastructure} ${pythoneda-shared-artifact-infrastructure} ${pythoneda-shared-pythonlang-domain} ${pythoneda-shared-pythonlang-artf-domain} ${pythoneda-shared-pythonlang-infrastructure}; do
